...
/*
 * PlayerClientTransferAssetRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientTransferAssetRequestInput : public Model
{
public:
    virtual ~PlayerClientTransferAssetRequestInput() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	TArray<PlayerClientTransferAssetRequestInputAssetsInner> Assets;
