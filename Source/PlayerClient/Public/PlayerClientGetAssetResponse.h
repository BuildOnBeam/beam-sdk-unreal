...
/*
 * PlayerClientGetAssetResponse
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientGetAssetResponse : public Model
{
public:
    virtual ~PlayerClientGetAssetResponse() {}
	...
	FString AssetId;
	double Supply;
	TOptional<TArray<PlayerClientGetAssetResponseOwnersInner>> Owners;
