...
/*
 * PlayerClientConvertTokenRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientConvertTokenRequestInput : public Model
{
public:
    virtual ~PlayerClientConvertTokenRequestInput() {}
