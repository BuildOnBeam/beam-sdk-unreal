...
struct PLAYERCLIENT_API HttpRetryManager
	: public FManager
...
struct PLAYERCLIENT_API HttpRetryParams
{
	HttpRetryParams(
...
class PLAYERCLIENT_API Request
{
public:
	virtual ~Request() {}
...
class PLAYERCLIENT_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
