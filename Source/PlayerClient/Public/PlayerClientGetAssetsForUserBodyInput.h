...
/*
 * PlayerClientGetAssetsForUserBodyInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientGetAssetsForUserBodyInput : public Model
{
public:
    virtual ~PlayerClientGetAssetsForUserBodyInput() {}
