...
/*
 * PlayerClientCommonContractActivityRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientCommonContractActivityRequestInput : public Model
{
public:
    virtual ~PlayerClientCommonContractActivityRequestInput() {}
