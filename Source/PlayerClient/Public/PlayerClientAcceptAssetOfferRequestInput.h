...
/*
 * PlayerClientAcceptAssetOfferRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientAcceptAssetOfferRequestInput : public Model
{
public:
    virtual ~PlayerClientAcceptAssetOfferRequestInput() {}
