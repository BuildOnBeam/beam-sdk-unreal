...
/*
 * PlayerClientTransferNativeTokenRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientTransferNativeTokenRequestInput : public Model
{
public:
    virtual ~PlayerClientTransferNativeTokenRequestInput() {}
