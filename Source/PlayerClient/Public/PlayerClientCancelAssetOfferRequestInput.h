...
/*
 * PlayerClientCancelAssetOfferRequestInput
 *
 * 
 */
class PLAYERCLIENT_API PlayerClientCancelAssetOfferRequestInput : public Model
{
public:
    virtual ~PlayerClientCancelAssetOfferRequestInput() {}
