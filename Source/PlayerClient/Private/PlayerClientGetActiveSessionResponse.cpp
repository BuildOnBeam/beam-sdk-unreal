...
void PlayerClientGetActiveSessionResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetActiveSessionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
