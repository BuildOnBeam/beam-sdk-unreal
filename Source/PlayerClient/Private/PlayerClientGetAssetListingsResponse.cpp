...
void PlayerClientGetAssetListingsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetAssetListingsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
