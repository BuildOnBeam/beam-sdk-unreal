...
void PlayerClientGetTransactionResponseUserEntitiesInner::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetTransactionResponseUserEntitiesInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
