...
void PlayerClientGetUserCurrenciesResponseDataInner::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetUserCurrenciesResponseDataInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
