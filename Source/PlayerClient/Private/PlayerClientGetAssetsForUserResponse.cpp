...
void PlayerClientGetAssetsForUserResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetAssetsForUserResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
