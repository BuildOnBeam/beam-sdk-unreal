...
void PlayerClientTransferAssetRequestInputAssetsInner::WriteJson(JsonWriter& Writer) const
{
	...
	{
		Writer->WriteIdentifierPrefix(TEXT("amountToTransfer")); WriteJsonValue(Writer, AmountToTransfer.GetValue());
	}
	Writer->WriteObjectEnd();
}

bool PlayerClientTransferAssetRequestInputAssetsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
