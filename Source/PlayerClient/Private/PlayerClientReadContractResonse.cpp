...
void PlayerClientReadContractResonse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientReadContractResonse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
