...
void PlayerClientCommonActivityResponseDataInnerTransaction::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientCommonActivityResponseDataInnerTransaction::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
