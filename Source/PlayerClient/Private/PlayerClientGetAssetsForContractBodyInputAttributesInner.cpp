...
void PlayerClientGetAssetsForContractBodyInputAttributesInner::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetAssetsForContractBodyInputAttributesInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
