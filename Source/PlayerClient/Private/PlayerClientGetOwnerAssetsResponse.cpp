...
void PlayerClientGetOwnerAssetsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetOwnerAssetsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
