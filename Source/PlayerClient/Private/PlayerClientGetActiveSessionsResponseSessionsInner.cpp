...
void PlayerClientGetActiveSessionsResponseSessionsInner::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetActiveSessionsResponseSessionsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
