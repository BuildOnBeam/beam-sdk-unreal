...
void PlayerClientGetAssetResponseOwnersInner::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetAssetResponseOwnersInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
