...
void PlayerClientGetAssetsForContractResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetAssetsForContractResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
