...
void PlayerClientCommonStatsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientCommonStatsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
