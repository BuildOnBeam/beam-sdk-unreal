...
void PlayerClientGetTransactionsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool PlayerClientGetTransactionsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
